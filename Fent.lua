...
do
	...
	do
		...
		Font:Register("LunarFont", 400, "normal", {Id = "ProggyClean.ttf", Font = ""});
	end
	...
	do
		function Library:NewPicker(name, default, defaultalpha, parent, count, flag, callback)
			...
			ColorWindow.Size = UDim2.new(0,150,0,126)
	...
	do
		...
		function Library:Window(Options)
			...
			--
			local FentFun = Instance.new("ScreenGui", game:GetService("RunService"):IsStudio() and game.Players.LocalPlayer.PlayerGui or game.CoreGui)
			...
			Logo.Name = "Logo"
			Logo.Image = "http://www.roblox.com/asset/?id=17072879454"
			...
			ResizeButton.FontFace = Font.new("rbxasset://fonts/families/SourceSansPro.json")
			ResizeButton.Text = ""
			...
			function Window:KeyList() -- finobe wanted me to paste off eclipse incase this ever gets leaked LOL
				...
				function NKeyList:NewKey(Key, Name, Mode)
					...
					KName.FontFace = Font.fromEnum(Enum.Font.GothamBold)
		...
		function Library:Page(Properties)
			...
			NewTab.Name = "NewTab"
			NewTab.FontFace = Font.new("rbxasset://fonts/families/SourceSansPro.json")
			NewTab.Text = ""
		...
		function Pages:Section(Properties)
			...
			SectionName.FontFace = Font.fromEnum(Enum.Font.GothamBold)
		...
		function Sections:Toggle(Properties)
			...
			function Toggle:Keybind(Properties)
				...
				Hold.ZIndex = 2
				Hold.FontFace = Font.fromEnum(Enum.Font.GothamBold)
				Hold.Text = "Hold"
				...
				Toggle.ZIndex = 2
				Toggle.FontFace = Font.fromEnum(Enum.Font.GothamBold)
				Toggle.Text = "Toggle"
				...
				Always.ZIndex = 2
				Always.FontFace = Font.fromEnum(Enum.Font.GothamBold)
				Always.Text = "Always"
		...
		function Sections:Slider(Properties)
			...
			NewSlider.FontFace = Font.new("rbxasset://fonts/families/SourceSansPro.json")
			NewSlider.Text = ""
		...
		function Sections:List(Properties)
			...
			local function createoptions(tbl)
				for _, option in next, tbl do
					...
					Value1.Name = "Value"
					Value1.FontFace = Font.fromEnum(Enum.Font.GothamBold)
					Value1.Text = option
		...
		function Sections:Keybind(Properties)
			...
			NewBind.FontFace = Font.new("rbxasset://fonts/families/SourceSansPro.json")
			NewBind.Text = ""
		...
		function Pages:PlayerList(Properties)
			...
			PlayerName1.FontFace = Font.fromEnum(Enum.Font.GothamBold)
			...
			PriorityLabel.FontFace = Font.fromEnum(Enum.Font.GothamBold)
			...
			FriendLabel.FontFace = Font.fromEnum(Enum.Font.GothamBold)
			...
			local function createoptions(tbl)
				for i, option in next, tbl do
					...
					PlayerName.FontFace = Font.fromEnum(Enum.Font.GothamBold)
					...
					PlayerStatus.FontFace = Font.fromEnum(Enum.Font.GothamBold)
					...
					PlayerStatus.TextColor3 = option == game.Players.LocalPlayer and Color3.fromRGB(0, 170, 255) or table.find(Library.Friends, option) and Color3.fromRGB(0,255,0) or table.find(Library.Priorities, option) and Color3.fromRGB(255,0,0) or Color3.fromRGB(200,200,200)
